...
//print("The value of foo is \(foo)")
//it wil generate an error because foo is not in its scope as it is a local variable inside the loop and it does not have any scope outside the loop
...
//in this x is a global variable as it is defined outside the loop
...
greeting(greeting: nil, name: "Chirag")
greeting(greeting: "Hi there,", name: "Chirag")
