 ...
 */
var walkingChallenges = ["Walk 3 miles a day" , "Walk for 30 mins a day"]
var runningChallenges = ["Run 5 times a week" , "Run for 20 min straight everyday"]
...
if completedTasks.isEmpty {
    print("Commit to challenges")
}
else if completedTasks.count == 1 {
    print("The challenges you have chosen is \(completedTasks[1])")
}
else{
