...
//print(falcon.weapon)
// it does not work because falcon is an instance of spaceship and it is the parent class and weapon is a property of Fighter class which is child class and parent does not inherit properties from the children
